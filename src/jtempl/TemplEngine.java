...
public class TemplEngine {
	...
	public static FileOutput generate(File input_file) {
		...
		input.lines().forEach(line -> {
			...
			if (line.startsWith("#")) {
				...
				if (line.contains("import")) {
					imports.append(line.replaceAll(";", "")).append(";");
				} else {
					args = line;
				}
		...
		args = args == null ? "/*TODO: Support template args*/" : args;
...
class %s {
	public static String generate(%s) {
 		StringBuilder sb = new StringBuilder();
  %s
		return sb.toString();
  } 
    ...
    """;
		var class_full = String.format(class_template, imports.toString(), class_name, args, sb.toString().indent(4 * 4));
